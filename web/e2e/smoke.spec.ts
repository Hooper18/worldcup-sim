  ...
  models: {
    ...
    backtest: {
      best: {
        half_life_days: 730,
        weight_dc_elo: 0.2,
        weight_dc_attack: 0.8,
        pooled_rps: 0.188,
        oos_rps: 0.189,
        rps_baseline: 0.229,
        rps_elo_baseline: 0.192,
        n_events: 20,
        n_matches: 895,
      },
      years: {
      ...
      loto: {
        ...
        oos_brier: 0.57,
        oos_ece: 0.02,
        climatology_rps: 0.229,
        elo_baseline_rps: 0.192,
        logloss_gain_vs_elo: 0.01,
        n_folds: 20,
        n_matches: 895,
        reliability: [
          { p_pred: 0.1, freq: 0.09, ci_lo: 0.06, ci_hi: 0.12, n: 50 },
          { p_pred: 0.5, freq: 0.52, ci_lo: 0.45, ci_hi: 0.59, n: 30 },
        ],
        selected_H_counts: { '730': 17, '1095': 3 },
        selected_w_counts: { '0.2': 20 },
      },
    },
  },
}
...
const MATCHES = [
  {
    ...
    status: 'finished',
    result: { h: 2, a: 0, after: 'FT' },
    home: 'MEX',
    away: 'RSA',
    forecast: FORECAST,
    model_breakdown: {
      dc_elo: { p_home: 0.6, p_draw: 0.25, p_away: 0.15 },
      dc_attack: { p_home: 0.55, p_draw: 0.28, p_away: 0.17 },
    },
  },
  {
    id: 2,
    ...
    forecast: FORECAST,
    model_breakdown: {
      dc_elo: { p_home: 0.4, p_draw: 0.3, p_away: 0.3 },
      dc_attack: { p_home: 0.42, p_draw: 0.29, p_away: 0.29 },
    },
  },
  {
    id: 73,
    ...
    home: '2A',
    away: '2B',
    slot_dist: { home: [{ team: 'KOR', p: 0.33 }], away: [{ team: 'MEX', p: 0.4 }] },
  },
]
...
const GROUPS = {
  A: {
    MEX: {
      p_rank: [0.5, 0.3, 0.15, 0.05],
      p_top2: 0.8,
      p_third_advance: 0.1,
      p_advance: 0.9,
      exp_pts: 6,
      exp_gd: 2,
      current: { pts: 3, gd: 2, gf: 2, played: 1 },
    },
    RSA: {
      p_rank: [0.05, 0.15, 0.3, 0.5],
      p_top2: 0.2,
      p_third_advance: 0.1,
      p_advance: 0.3,
      exp_pts: 2,
      exp_gd: -2,
      current: { pts: 0, gd: -2, gf: 0, played: 1 },
    },
    KOR: {
      p_rank: [0.3, 0.3, 0.25, 0.15],
      p_top2: 0.6,
      p_third_advance: 0.15,
      p_advance: 0.75,
      exp_pts: 4,
      exp_gd: 0,
      current: null,
    ...
    CZE: {
      p_rank: [0.15, 0.25, 0.3, 0.3],
      p_top2: 0.4,
      p_third_advance: 0.12,
      p_advance: 0.52,
      exp_pts: 3,
      exp_gd: 0,
      current: null,
...
const KNOCKOUT = {
  teams: Object.fromEntries(
    Object.keys(TEAMS).map((c) => [
      c,
      { p_r32: 0.8, p_r16: 0.5, p_qf: 0.3, p_sf: 0.2, p_final: 0.1, p_champion: 0.05 },
    ]),
  ),
...
const EVOLUTION = {
  ...
  teams: Object.fromEntries(
    Object.keys(TEAMS).map((c) => [
      c,
      { champion: [0.05, 0.06], final: [0.1, 0.11], sf: [0.2, 0.21], advance: [0.8, 0.82] },
    ]),
  ),
}
